...
export const DETAILS_CONFIG = {
  ...
  estaciones: {
    ...
    fields: [
      { key: 'nombre', label: STRINGS.name.toUpperCase() },
      { key: 'codigo', label: STRINGS.code.toUpperCase() },
      { key: 'direccion', label: STRINGS.adress.toUpperCase() },
      { key: 'provincia.nombre', label: STRINGS.province.toUpperCase() },
      { key: 'municipio.nombre', label: STRINGS.municipality.toUpperCase() },
      { key: 'nit', label: STRINGS.nit.toUpperCase(), format: (val) => val?.toLocaleString() },
      { key: 'cuentaCuc.numero', label: STRINGS.cuentaCUC.toUpperCase() },
      {
        key: 'cuentaCuc.banco.codigo',
        label: `${STRINGS.bank.toUpperCase()} ${STRINGS.cuentaCUC.toUpperCase()}`,
      },
      { key: 'cuentaCup.numero', label: STRINGS.cuentaCUP.toUpperCase() },
      {
        key: 'cuentaCup.banco.codigo',
        label: `${STRINGS.bank.toUpperCase()} ${STRINGS.cuentaCUP.toUpperCase()}`,
      },
      {
        key: 'telefonos',
  ...
  cuenta: {
    ...
    fields: [
      ...
      { key: 'banco.codigo', label: STRINGS.bancoCuenta },
      { key: 'tipo.codigo', label: STRINGS.type_of_account },
    ],
  },
