...
import tabs_store from 'src/pages/manage/tabs/tabs_store.vue'
...
const callEmptySelected = () => {
  if (tabs_store_ref.value) {
    tabs_store_ref.value.EmptySelected()
  } else {
    ...
    setTimeout(() => {
      if (tabs_store_ref.value) {
        ...
        console.warn('La referencia tabs_store_ref aún no está disponible')
      }
    }, 3000)
  }
}
