    ...
    <q-dialog v-model="dialog" persistent ref="refDialogoAdd" :backdrop-filter="backdropFilter"
      ...
      <q-card class="my-dialog-card">
        <q-card-section class="row items-center text-white q-pb-none text-h6 bg-green-5 q-pa-md">
          ...
          <span class="icon-text">{{ STRINGS.add.toUpperCase() }} - {{ STRINGS.currency.toUpperCase() }}</span>
        </q-card-section>
        ...
        <q-card-section>
          <div class="row flex justify-between">
            <div class="col-4">
              <div class="q-px-sm">
                <q-input v-model="TextNombre_moneda" ref="textNombre_moneda" color="green"
            ...
            <div class="col-4">
              <div class="q-px-sm">
                <q-input v-model="TextTasaCambio_moneda" ref="textTasaCambio_moneda" color="green"
                  :rules="validaciones_generales.rulesExchangeRate" type="text" :label="STRINGS.tasa_de_Cambio"
                  @keyup="checkStatusInputs" />
              </div>
            </div>
          </div>
            ...
            <div class="col-5 flex justify-between">
              ...
              <div class="q-px-xs">
                <q-radio v-model="TextmBase_moneda" ref="textmBase_moneda" checked-icon="task_alt"
                  unchecked-icon="panorama_fish_eye" @onchange="checkStatusInputs" :val="STRINGS.yes"
                  :label="STRINGS.yes" />
                <q-radio v-model="TextmBase_moneda" ref="textmBase_moneda" checked-icon="task_alt"
          ...
          <div class="row flex justify-between q-mt-md">
            <div class="col-12">
              <div class="q-px-sm">
                <q-input v-model="TextIdCondor_moneda" ref="textIdCondor_moneda" color="green"
                  :rules="validaciones_generales.rulesCondorTextID" type="text" :label="STRINGS.id_condor"
                  @keyup="checkStatusInputs" />
              </div>
            </div>
          </div>
