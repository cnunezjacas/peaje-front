...
const tabs_nomenclator_ref = ref(null)
...
const callEmptySelected = () => {
  if (tabs_nomenclator_ref.value) {
    tabs_nomenclator_ref.value.EmptySelected()
  } else {
    ...
    setTimeout(() => {
      if (tabs_nomenclator_ref.value) {
        ...
        console.warn('La referencia tabs_nomenclator_ref aún no está disponible')
      }
    }, 3000)
  }
}
